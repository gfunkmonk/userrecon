...
scanner() {
  ...
  check1=$(
    curl -s -i "https://flipboard.com/@$username" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404'
    echo $?
  )
  ...
  check1=$(
    curl -s -i "https://angel.co/$username" -H "Accept-Language: en" -L | grep -o '404 Not Found'
    echo $?
  )
  ...
  check1=$(
    curl -s -i "https://creativemarket.com/$username" -H "Accept-Language: en" -L | grep -o '404eef72'
    echo $?
  )
  ...
  check1=$(
    curl -s -i "https://houzz.com/user/$username" -H "Accept-Language: en" -L | grep -o 'an error has occurred'
    echo $?
  )
